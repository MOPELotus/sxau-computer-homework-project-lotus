...
class Settings:
    ...
    chat_model: str = os.getenv("SILICONFLOW_CHAT_MODEL", "Qwen/Qwen3.5-27B").strip()
    embedding_model: str = os.getenv("SILICONFLOW_EMBEDDING_MODEL", "Qwen/Qwen3-Embedding-8B").strip()
